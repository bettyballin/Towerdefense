...
public class LoadGameTest {
	...
	String saveGame = "testmaps/extended1/save.Towerdefense";
	String saveGameRepresentation = "Map \"/assets/sandTexture.jpg\" \"correcte1\" \"null\" 0 9788 6\n" +
									"Tower\"PlayerOne\" 1000 998 10 4 3 3 30 5 155 10 441 211\n" +
									"Tower\"OpponentTank0\" 30 30 1 0 0 0 1 5 12 10 371 473\n" +
									"Border 400 0 800 0\n" +
									"Border 0 300 0 600\n" +
