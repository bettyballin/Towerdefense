...
import model.entities.Mine;
import model.entities.Tank;
import ui.Towerdefense;
import eea.engine.entity.Entity;
import eea.engine.entity.StateBasedEntityManager;

public class TowerdefenseTestAdapterExtended1 extends TanksTestAdapterMinimal {
	...
	public int getMineMaxAmmo() {
		...
		List<Tower> tanks = new ArrayList<Tower>();

		for (Entity entity : entities) {
			if(entity.toString().startsWith("Tank")) {
				tanks.add((Tower) entity);
			}
		}
